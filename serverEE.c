...
int main(void) {
    ...
    printf("The Server EE is up and running using UDP on port %s number>.\n", MYPORT);
    fflush(stdout);
        ...
        buf[numbytes] = '\0';
        printf("The Server EE received a request from the Main Server about the %s\n",buf);
        FILE* ptr;
        char myText[100];
        strcpy(myText, buf);
        char result[100];
